...
path = 'C:\\Users\\sunitha G\\dm_offshore\\methods_framework\\projects\\sample\\output\\logs\\'+datetime.now().strftime("%d_%B_%Y_%H_%M_%S")+'.log'


################################################### 1. Import libraries ###################################################
os.chdir(r"C:\Users\sunitha G\dm_offshore\methods_framework\projects\sample\code\current")
from methods_all_v1_1_12th_nov_2019_mon_9_am import *

os.chdir(r"C:\Users\sunitha G\dm_offshore\methods_framework\projects\sample\output\results")
msg = "\n ######################################## Import libraries completed ########################################\n"
file_name = 'myapp.log'
path = 'C:\\Users\\sunitha G\\dm_offshore\\methods_framework\\projects\\sample\\output\\results\\'+datetime.now().strftime("%d_%B_%Y_%H_%M_%S")+'.log'
...
os.chdir(r"C:\Users\sunitha G\dm_offshore\methods_framework\projects\sample\input")
...
X_train,y_train,feat_importances,model,confusion_matrix1,classification_report1 = train_model(X_train,X_test,y_train,y_test,X,y,'RF',df_ohe)
